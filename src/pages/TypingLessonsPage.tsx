...
import { BookOpen, Plus, Loader2, Save, Trash2, Languages, Clock, Power, PowerOff, Target, Zap } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500 pb-10">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1 text-sm font-medium">Create and manage lessons for student typing practice.</p>
          </div>
          <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-2.5 rounded-none border border-border bg-background text-sm font-bold focus:border-primary outline-none" 
                      value={form.min_wpm}
                      onChange={(e) => setForm({...form, min_wpm: parseInt(e.target.value)})}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      onChange={(e) => setForm({...form, min_accuracy: parseInt(e.target.value)})}
                    />
                  </div>
                </div>
                <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {loading ? (
            ...
            <div className="col-span-full py-20 border border-border border-dashed text-center opacity-60">
              <p className="text-xs font-black uppercase tracking-[0.2em] text-muted-foreground">No lessons created yet</p>
            </div>
          ) : (
            lessons.map(lesson => (
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    <button 
                      ...
                      className={cn(
                        "flex-1 px-4 py-2 border text-[9px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2",
                    ...
                    <button 
                      ...
                      className="px-4 py-2 border border-border text-destructive hover:bg-destructive hover:text-white transition-all"
                    >
