...
pub async fn run_server() {
    ...
    let app = Router::new()
        ...
        .route("/api/admin/users/:id/toggle-active", post(handlers::admin::toggle_user_status))
        ...
        .route("/api/typing/lessons/:id", delete(handlers::typing::delete_lesson).patch(handlers::typing::toggle_lesson_status).put(handlers::typing::update_lesson))
        ...
        .route("/api/exam/questions/feedback/:id/status", put(handlers::exam_engine::update_question_feedback_status))
        ...
        .route("/api/library/issue", post(handlers::library::issue_book).get(handlers::library::list_issued_books))
        .route("/api/library/issued/:id/return", put(handlers::library::return_book))
        .route("/api/library/my-issued", get(handlers::library::get_my_issued_books))
        .route("/api/library/reserve", post(handlers::library::reserve_book))
        .route("/api/library/reservations", get(handlers::library::list_reservations))
        .route("/api/library/reservations/:id/cancel", put(handlers::library::cancel_reservation))
        .route("/api/library/reservations/:id/fulfill", put(handlers::library::fulfill_reservation))
        .route("/api/library/analytics", get(handlers::library::get_library_analytics))
