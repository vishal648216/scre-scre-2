...
pub async fn run_server() {
    ...
    let app = Router::new()
        ...
        .route("/api/admin/centers/pending", get(handlers::center::get_pending_center_registrations))
        .route("/api/admin/centers/:id/approve-registration", post(handlers::center::approve_center_registration))
        .route("/api/admin/centers/:id/reject-registration", post(handlers::center::reject_center_registration))
        ...
        .route("/api/courses/bulk", post(handlers::course::bulk_create_courses))
        ...
        .route("/api/academic/sessions/bulk", post(handlers::academic::bulk_create_sessions))
        ...
        .route("/api/staff/attendance", get(handlers::staff::get_staff_attendance).post(handlers::staff::save_staff_attendance))
        .route("/api/staff/leaves", get(handlers::staff::get_staff_leaves).post(handlers::staff::create_staff_leave))
        .route("/api/staff/leaves/:id", put(handlers::staff::update_staff_leave_status))
        .route("/api/staff/overtime", get(handlers::staff::get_staff_overtime).post(handlers::staff::create_staff_overtime))
        .route("/api/staff/payroll/disburse", post(handlers::staff::disburse_staff_payroll))
        .route("/api/staff/payroll/history", get(handlers::staff::get_staff_payroll_history))
        ...
        .route("/api/finance/incomes", get(handlers::finance::list_incomes).post(handlers::finance::create_income))
        .route("/api/finance/incomes/:id", delete(handlers::finance::delete_income))
        .route("/api/finance/expenses", get(handlers::finance::list_expenses).post(handlers::finance::create_expense))
        .route("/api/finance/expenses/:id", delete(handlers::finance::delete_expense))
        .route("/api/finance/payouts", get(handlers::finance::list_payouts))
        .route("/api/finance/payouts/disburse", post(handlers::finance::create_payout))
        .route("/api/finance/adjustments", get(handlers::finance::list_adjustments).post(handlers::finance::create_adjustment))
        .route("/api/finance/summary", get(handlers::finance::get_financial_summary))
        ...
        .route("/api/qb/questions/bulk", post(handlers::qb::bulk_create_questions))
        ...
        .route("/api/exam/mock-tests/bulk", post(handlers::mock_test::bulk_create_mock_tests))
        .route(
            "/api/exam/mock-tests",
        ...
        .route("/api/exam/purge-test-data", post(handlers::exam_engine::purge_fake_exam_data))
        ...
        .route("/api/admin/categories/bulk", post(handlers::course_categories::bulk_create_categories))
        ...
        .route("/api/library/issues", get(handlers::library::get_book_issues).post(handlers::library::issue_book))
        .route("/api/library/issues/:id/return", put(handlers::library::return_book))
        .route("/api/library/issues/:id/send-reminder", post(handlers::library::send_issue_reminder))
        .route("/api/library/issues/:id/reissue", put(handlers::library::reissue_book))
        .route("/api/library/student/my-issues", get(handlers::library::get_my_issued_books))
        .route("/api/library/reservations", get(handlers::library::get_reservations).post(handlers::library::reserve_book))
        .route("/api/library/reservations/:id/convert-to-issue", post(handlers::library::convert_reservation_to_issue))
        .route("/api/library/purge-test-data", post(handlers::library::purge_library_test_data))
